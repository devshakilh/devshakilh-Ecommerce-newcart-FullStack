...
const Products = () => {
    ...
    const [sizeToggle, setSizeToggle] = useState(true); // Toggle state for size filter
    ...
    useEffect(() => {
        ...
        dispatch(getProducts(keyword, category, price, ratings, size, currentPage)); // Pass size to getProducts
    }, [dispatch, keyword, category, price, ratings, size, currentPage, error, enqueueSnackbar]);

    return (
        <>
            <MetaData title="All Products | Newcart" />
                        ...
                        <div className="flex flex-col bg-white rounded-sm shadow">
                            ...
                            <div className="flex flex-col gap-2 py-3 text-sm overflow-hidden">
                                ...
                                <div className="flex flex-col border-b px-4">
                                    ...
                                    <div className="flex justify-between cursor-pointer py-2 pb-4 items-center" onClick={() => setSizeToggle(!sizeToggle)}>
                                        <p className="font-medium text-xs uppercase">Size</p>
                                        {sizeToggle ?
                                            <ExpandLessIcon sx={{ fontSize: "20px" }} /> :
                                            <ExpandMoreIcon sx={{ fontSize: "20px" }} />
                                        }
                                    ...
                                    {sizeToggle && (
                                        <div className="flex flex-col pb-1">
                                            {/* Add your size selection UI here */}
                                            <FormControl>
                                                <RadioGroup
                                                    aria-labelledby="size-radio-buttons-group"
                                                    onChange={(e) => setSize(e.target.value)}
                                                    value={size}
                                                    name="size-radio-buttons"
                                                >
                                                    <FormControlLabel value="S" control={<Radio size="small" />} label="Small" />
                                                    <FormControlLabel value="M" control={<Radio size="small" />} label="Medium" />
                                                    <FormControlLabel value="L" control={<Radio size="small" />} label="Large" />
