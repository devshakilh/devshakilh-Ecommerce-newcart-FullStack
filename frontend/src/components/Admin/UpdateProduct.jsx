...
const UpdateProduct = () => {
    ...
    const handleProductImageChange = (e) => {
        ...
        // Limit the number of files to between 3 and 4
        const selectedFiles = files.slice(0, Math.min(3, Math.max(7, files.length)));
    ...
    return (
        <>
            <MetaData title="Admin: Update Product | Newcart" />
