...
import VerifiedIcon from '@mui/icons-material/Verified'; // MUI verified icon
import UnverifiedIcon from '@mui/icons-material/Close'; // MUI unverified icon
...
const ProductDetails = () => {
    ...
    const hasPurchasedProducts = useSelector(state => state.user.hasPurchasedProduct);
    // reviews toggle
    ...
    const hasPurchasedProduct = () => {
        // Replace with your logic to check if the user has purchased the product
                                ...
                                <div className="flex flex-col gap-2 mb-4">
                                    ...
                                    {Array(3).fill("").map((el, i) => (
                                        <p className="text-sm flex items-center gap-1" key={i}>
                                            ...
                                            <span className="font-medium ml-2">Bank Offer</span> 15% Instant discount on first Newcart Pay Later order of 500 and above <Link className="text-primary-blue font-medium" to="/">T&C</Link>
                                        </p>
                                    ))}
                                    {/* <!-- banks offers --> */}
                                    ...
                                    {/* <!-- seller details --> */}
                                    <div className="flex gap-16 mt-4 items-center text-sm font-medium">
                                        <p className="text-gray-500">Seller {hasPurchasedProduct() && (
                                                <VerifiedUserIcon
                                                    sx={{ fontSize: "18px", color: "#34D399" }}
                                                />
                                            )}</p>
                                            ...
                                            product.reviews?.map((rev, i) => (
                                                <div className="flex flex-col gap-2 py-4 px-6 border-b" key={i}>
                                                   ...
                                                   <p>{rev.comment}</p>
                                                    ...
                                                    {hasPurchasedProduct ? (
                    <VerifiedIcon className="text-green-500 ml-2 !text-[18px]" />
                ) : (
                    <UnverifiedIcon className="text-red-500 ml-2 !text-[18px]" />
                )}
                                                   </div>
                                                   
                                                    {/* <img draggable="false" src={rev.avatar.url} alt={product.seller.name} className="w-14 h-14 object-contain rounded-full" /> */}
                                                </div>
