    ...
    const navs = [
        {
            ...
            redirect: "https://www.Newcart.com/communication-preferences/push",
        },
        {
            title: "Sell on Newcart",
            icon: <BusinessCenterIcon sx={{ fontSize: "18px" }} />,
            redirect: "https://seller.Newcart.com/sell-online",
        },
        {
        ...
        },
        {
            ...
            redirect: "https://advertising.Newcart.com",
        },
        {
            title: "Download App",
            icon: <DownloadIcon sx={{ fontSize: "18px" }} />,
            redirect: "https://www.Newcart.com/mobile-apps",
        },
    ]
